...
document.addEventListener("DOMContentLoaded", () => {
    ...
    const matchesHistoryList = document.getElementById("matchesHistoryList") as HTMLDivElement | null;
    const matchesCountBadge = document.getElementById("matchesCountBadge") as HTMLSpanElement | null;

    if (!groupIdInput || !groupNameTitle || !matchesHistoryList || !matchesCountBadge) return;
